...
@class LineSDKLoginManagerWebAuthenticationMethod;
...
@property (nonatomic, strong) LineSDKLoginManagerWebAuthenticationMethod * _Nonnull initialWebAuthenticationMethod;
...
SWIFT_CLASS("_TtC11LineSDKObjC42LineSDKLoginManagerWebAuthenticationMethod")
@interface LineSDKLoginManagerWebAuthenticationMethod : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKLoginManagerWebAuthenticationMethod * _Nonnull email;)
+ (LineSDKLoginManagerWebAuthenticationMethod * _Nonnull)email SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKLoginManagerWebAuthenticationMethod * _Nonnull qrCode;)
+ (LineSDKLoginManagerWebAuthenticationMethod * _Nonnull)qrCode SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, copy) NSString * _Nonnull rawValue;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSString * _Nullable loginRoute;
- (void)stop;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
