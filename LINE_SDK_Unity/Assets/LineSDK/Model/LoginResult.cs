...
namespace Line.LineSDK {
    ...
    public class LoginResult {
        ...
        /// <summary>
        /// The `nonce` value when requesting an ID Token during the login process. Use this value as a parameter when you
        /// verify the ID Token against the LINE server. This value is `nil` if you don't have the `.openID` permission.
        /// </summary>
